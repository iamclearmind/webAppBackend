...
class LTF11(bt.Strategy):
    ...
    def __init__(self):
        ...
        for d in self.datas :
            ...
            self.inds[d]['buy_condition'] = btind.crossover.CrossUp(d.high,self.inds[d]['MACHH'])
    ...
    def next(self):
        ...
        for d in self.d_with_len:
            ...
            if self.getposition(data=d).size < self.params.trade_size and d.close[0] > self.inds[d]['MACHH'][0] :
            ...
            if self.getposition(data=d).size > 0 and d.close[0] < self.inds[d]['csma50'][0] :
